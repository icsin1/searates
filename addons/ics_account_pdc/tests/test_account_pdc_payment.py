...
class TestAccountPaymentAdjustment(PaymentAdjustmentCommon):
    ...
    def test_invoice_full_payment(self):
        ...
        self._validate_pdc_payment_adjustment(invoice_data, payment_data, result_data, move_type='in_invoice')
        self._validate_pdc_payment_registered(invoice_data, result_data, move_type='in_invoice')
