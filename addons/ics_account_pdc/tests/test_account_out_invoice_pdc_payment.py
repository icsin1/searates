...
from odoo.addons.ics_account_pdc.tests.common import PaymentAdjustmentCommon
...
class TestAccountPaymentAdjustment(PaymentAdjustmentCommon):
    ...
    def test_invoice_full_payment(self):
        ...
        self._validate_pdc_payment_adjustment(invoice_data, payment_data, result_data, move_type='out_invoice')
        self._validate_pdc_payment_registered(invoice_data, result_data, move_type='out_invoice')
    ...
    def test_invoice_full_payment_with_foreign_currency_aed(self):
        """ Local Currency: AED
            Invoice Currency: AED
    ...
    def test_invoice_full_payment_with_foreign_currency_usd(self):
        """ Local Currency: AED
