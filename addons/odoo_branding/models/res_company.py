...
class Company(models.Model):
    ...
    def _get_default_favicon(self, original=False):
        img_path = get_resource_path('odoo_branding', 'static/images/favicon.png')
    ...
    favicon = fields.Binary(string="Company Favicon", help="This field holds the image used to display a favicon for a given company.", default=False)
