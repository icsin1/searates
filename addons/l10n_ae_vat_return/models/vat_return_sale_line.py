...
class VATReturnSaleLine(models.Model):
    _name = "vat.return.sale.line"
    _description = "Vat Return Sale Line"
    ...
    actual_base_amount = fields.Float('Actual Base Amount', compute="_compute_vat_amount", store=True)
    actual_tax_amount = fields.Float('Actual Tax Amount', compute="_compute_tax_amount", store=True)
    ...
    # function to call report engine
